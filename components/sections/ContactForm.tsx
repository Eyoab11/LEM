...
import { SocialShareTracker } from '@/components/analytics/SocialShareTracker';
...
export const ContactForm = () => {
  ...
  return (
    <section className="bg-black pb-16 px-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="flex items-center gap-4 bg-white/10 backdrop-blur-md rounded-full px-6 py-3 border border-white/20">
            <SocialShareTracker 
              platform="facebook" 
              url="https://www.facebook.com/levyeromomedia"
            ...
            <SocialShareTracker 
              platform="twitter" 
              url="https://x.com/LevyEromoMedia"
              className="text-gray-400 hover:text-white transition-colors duration-300"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <SocialShareTracker 
              platform="linkedin" 
              url="https://www.linkedin.com/company/levy-eromo-media/"
              className="text-gray-400 hover:text-white transition-colors duration-300"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
